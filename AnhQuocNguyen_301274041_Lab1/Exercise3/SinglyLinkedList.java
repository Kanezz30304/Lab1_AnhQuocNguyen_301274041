...
public class SinglyLinkedList<E> implements Cloneable {
    ...
    public static void main(String[] args) {
         SinglyLinkedList<String> circularlist=new SinglyLinkedList<>();
         circularlist.addFirst("LAX");
         circularlist.addFirst("MSP");
         circularlist.addFirst("ATL");
         circularlist.addFirst("BOS");
        ...
        try{
            SinglyLinkedList<String> cloneList = circularlist.clone();
            System.out.println("Cloned List:" +cloneList);
        }catch (CloneNotSupportedException ce){
            System.out.println("Exeption thrown"+ce);
        }
